...
namespace BOCS
{
    ...
    public abstract class BOCSObject
    {
        ...
        /// </summary>
        public Dictionary<IAction, List<IBehaviour>> Behaviours { get; private set; } = new Dictionary<IAction, List<BehaviourBase>>();
        ...
        /// <exception cref="ArgumentNullException">Raised when behaviour is null.</exception>
        /// <remarks>
        ...
        public void AddBehaviour(BehaviourBase behaviour)
        {
            ...
            foreach (IAction action in actions)
            {
                ...
                {
                    Behaviours[action] = new List<BehaviourBase>();
                }
        ...
        /// <returns></returns>
        public int RemoveAllBehavioursOfType<Action>() where Action : class
        {
        ...
        {
            return Behaviours.Values.Any(l => l.Any(b => b.GetType().Equals(typeof(T))));
        }

        /// <typeparam name="T"></typeparam>
        /// <returns>An IEnumerable containing all Behaviours that implement the provided type.</returns>
        public IEnumerable<T> GetAllBehavioursOfType<T>() where T : class
        {
            return Behaviours[typeof(T)].Cast<T>();
        }
